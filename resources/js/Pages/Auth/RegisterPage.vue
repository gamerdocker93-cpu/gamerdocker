                    ...
                    <div class="w-full bg-white rounded-lg shadow-lg md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-700 dark:border-gray-700">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div class="mt-4 px-4">
                                <form @submit.prevent="registerSubmit" method="post" action="" class="">
                                    ...
                                    <div class="mb-3 mt-5" v-if="isReferral && !registerForm.reference_code">
                                        ...
                                        <div v-if="isReferral && !registerForm.reference_code" class="relative mb-3 mt-1">
                                            ...
                                            <input type="text" name="reference_code" v-model="registerForm.reference_code" class="input-group" :placeholder="$t('Code')" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 mt-11">
                                        <div class="flex">
                                            ...
                                            >
                                            <label for="term-a" class="ml-2 text-sm font-medium text-left text-gray-900 dark:text-gray-300">
                                                {{ $t('I agree to the User Agreement & confirm I am at least 18 years old') }}
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="flex items-center">
                                            <input
                                                ...
                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                            >
                                            <label for="term-agreement" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                                {{ $t('I agree with the') }}
                                                <a href="#" class="text-primary hover:underline">{{ $t('terms and conditions') }}</a>.
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <!-- Social login: IMPORTANTE usar href normal (não router.push), senão em HASH mode cai na HOME -->
                                <div class="login-wrap mt-5">
                                    ...
                                    <div class="social-group mt-3">
                                        <a
                                            :href="redirectSocialTo()"
                                            class="text-social-button hover:text-white focus:ring-4 focus:outline-none font-medium text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:hover:text-white"
                                        >
...
export default {
    ...
    mounted() {
        ...
        if (this.router.currentRoute.value.params.code) {
            try {
                // tenta interpretar como base64 json
                atob(this.router.currentRoute.value.params.code);
    ...
    methods: {
        // IMPORTANTE: precisa ser navegação "real" (href), não rota do Vue
        redirectSocialTo() {
        ...
        async registerSubmit() {
            ...
            await HttpApi.post("auth/register", this.registerForm)
                .then((response) => {
